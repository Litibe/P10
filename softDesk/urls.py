...
from softDeskApi.views import CommentIntoProjectView, IssuesIntoProjectView, ProjectView, ProjectListView, UserIntoProjectView, main_page
...
urlpatterns = [
    ...
    path('projects/',
         ProjectListView.as_view({"get": "list_projects",
    ...
    path('projects/<id_project>/issues/<id_issue>/',
         IssuesIntoProjectView.as_view({"put": "modify_issues", "delete": "delete_issue"}), name='del_issue'),
